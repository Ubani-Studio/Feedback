		...
		"boxes": [
						...
						"boxes": [
							...
							},
							{
								"box": {
									"id": "rs-label",
									"maxclass": "comment",
									"text": "Root snap-back\nPresets store home value\nMouseup recalls if toggle ON",
									"numinlets": 1,
									"numoutlets": 0,
									"patching_rect": [
										30.0,
			...
			},
			{
				"box": {
					...
					"text": "root 110, flex 0.5, master_gain 0.7, glide 0.001, brightness 0",
					"patching_rect": [
						310.0,
						195.0,
						370.0,
